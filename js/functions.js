...
var helloMessage = sayHello("Leroy");
 ...
 */
var tipDecimal = parseFloat(prompt("What is the tip in decimal?"));
var totalAmount = parseInt(prompt("What is the total amount?"));

console.log(totalAmount);
console.log(tipDecimal);
alert(calculateTip(tipDecimal, totalAmount));
...
var originalPrice = x;
var discountPercent = y;
var totalValue = originalPrice - (originalPrice * discountPercent);
